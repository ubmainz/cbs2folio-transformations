...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:variable name="xsl-name-liste" select="('itemNoteTypeId','holdingsNoteTypeId','materialTypeId','identifierTypeId','sourceId','permanentLoanTypeId',
        'instanceNoteTypeId','alternativeTitleTypeId','natureOfContentTermIds/arr/i','contributorTypeId','classificationTypeId','holdingsTypeId','modeOfIssuanceId','contributorNameTypeId','instanceRelationshipTypeId','processing/*/statisticalCoding/arr/i/setCode')"/>
    <xsl:variable name="api-name-liste" select="('item-note-types','holdings-note-types','material-types','identifier-types','holdings-sources','loan-types',
        'instance-note-types','alternative-title-types','nature-of-content-terms','contributor-types','classification-types','holdings-types','modes-of-issuance','contributor-name-types','instance-relationship-types','statistical-codes')"/>
