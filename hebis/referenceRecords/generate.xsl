...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:variable name="hascode-liste" select="(false(),false(),false(),false(),false(),false(),false(),false(),false(),true(),false(),false(),false()),true(),false()"/>
